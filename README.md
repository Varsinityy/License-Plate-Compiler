...
1. Download `PlateCompiler.exe` from the Releases page.
2. Choose your game version.
3. Pick your target region in the Compiler tab.
4. Drag and drop your images into the designated boxes.
5. Select your `Textures.zip` file or library folder depending on your game version.
6. Click **Compile Plates**.
